...
ENTITY_DETAILS = {
    ...
    'op_env_id_selected':{ 'name':'Envelope Selection','unit':None,'icon':None,'device_class':None,'state_class':None,'display_precison':None,'options':'data_options','mode':'None','category':None},
}
