...
from .number_properties import ENTITY_DETAILS
...
class RedbackTechNumberEntity(CoordinatorEntity, NumberEntity):
    ...
    def native_max_value(self) -> float:
        ...
        if ENTITY_DETAILS[self.ent_key[7:]] == "power_setting_watts":
            if (
                redback_entity_details[
                    self.ent_id + "inverter_max_export_power_kw"
                ].data["value"]
                is not None
            ):
                return (
