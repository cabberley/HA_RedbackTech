...
async def async_get_triggers(
    ...
    for entry in er.async_entries_for_device(registry, device_id):
        ...
        triggers.append({**base_trigger, CONF_TYPE: "offline"})
        triggers.append({**base_trigger, CONF_TYPE: "fault"})
...
async def async_attach_trigger(
    ...
    if config[CONF_TYPE] == "Fault":
        to_state = 'fault'
    elif config[CONF_TYPE] == "Offline":
        to_state = 'offline'
    elif config[CONF_TYPE] == "OK":
        to_state = 'ok'
    elif config[CONF_TYPE] == "unavailable":
        to_state = 'offline'
